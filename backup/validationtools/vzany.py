...
class VzAny():
    ...
    def build_vzany_dict(self, apic):
        ...
        if self.vzany_vrf_as_consumer.get('tn-common/ctx-GREEN_VRF'):
            if self.vzany_vrf_as_consumer['tn-common/ctx-GREEN_VRF'].get('consumed contracts'):
                write_file(f'{apic.output_directory}/vzany_GREEN_VRF_as_consumer_parsed.txt', self.vzany_vrf_as_consumer['tn-common/ctx-GREEN_VRF']['consumed contracts'])
        if self.vzany_vrf_as_consumer.get('tn-common/ctx-RED_VRF'):
            if self.vzany_vrf_as_consumer['tn-common/ctx-RED_VRF'].get('consumed contracts'):
                write_file(f'{apic.output_directory}/vzany_RED_VRF_as_consumer_parsed.txt', self.vzany_vrf_as_consumer['tn-common/ctx-RED_VRF']['consumed contracts'])
        if self.vzany_vrf_as_provider.get('tn-common/ctx-GREEN_VRF'):
            if self.vzany_vrf_as_provider['tn-common/ctx-GREEN_VRF'].get('provided contracts'):
                write_file(f'{apic.output_directory}/vzany_GREEN_VRF_as_provider_parsed.txt', self.vzany_vrf_as_provider['tn-common/ctx-GREEN_VRF']['provided contracts'])
        if self.vzany_vrf_as_provider.get('tn-common/ctx-RED_VRF'):
            if self.vzany_vrf_as_provider['tn-common/ctx-RED_VRF'].get('provided contracts'):
                write_file(f'{apic.output_directory}/vzany_RED_VRF_as_provider_parsed.txt', self.vzany_vrf_as_provider['tn-common/ctx-RED_VRF']['provided contracts'])
