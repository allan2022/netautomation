...
class ExternalSubnet():
    ...
    def build_external_subnet_epg_dict(self, apic):
        ...
        vrf_external_subnet_import_security_dict = build_external_subnet_dict.build_vrf_external_subnet_import_security_dict()
        vrf_external_subnet_import_security_dict_file_name = f'{self.output_directory}/VRF_External_subnets_import_security_parsed.txt'
        write_file(vrf_external_subnet_import_security_dict_file_name, vrf_external_subnet_import_security_dict)
        ...
        for build_class in build_external_subnet_epg_dict_sequence_list:
            apic.external_subnet_epg_import_security_no_endpoints_dict, apic.external_subnet_epg_import_rtctrl_dict, apic.external_subnet_epg_export_rtctrl_dict, \
                apic.external_subnet_epg_shared_security_dict, apic.external_subnet_epg_shared_rtctrl_dict = \
                self.build_external_subnet_epg_dict_sub(apic.external_subnet_epg_import_security_no_endpoints_dict, apic.external_subnet_epg_import_rtctrl_dict, 
    ...
    def build_external_subnet_epg_dict_sub(self, parent_dict_import_security, parent_dict_import_rtctrl, parent_dict_export_rtctrl, parent_dict_shared_security, parent_dict_shared_rtctrl, build_class, apic):
        ...
        return parent_dict_import_security, parent_dict_import_rtctrl, parent_dict_export_rtctrl, parent_dict_shared_security, parent_dict_shared_rtctrl
